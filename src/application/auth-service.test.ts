...
describe("CustomerService", () => {
  xit("should find user check if password match and createToken", async () => {
    ...
    const token = await customerService.singIn(
  ...
  xit("should return null when password doesnt  match", async () => {
    const save = sinon.spy();
